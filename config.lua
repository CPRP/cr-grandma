...
Config.IllegalMedicalTarget = {
    Coords = vector3(320.12, -193.99, 54.23), -- Coords for the Target
    Width = 0.5, -- Width for the Target
    Length = 0.5, -- Length for the Target
    Heading = 0, -- Heading for the Target
    minZ = 53.56, -- Minimum Z for the Target
    maxZ = 55.36, -- Maximum Z for the Target
...
Config.IllegalMedical = {
    Coords = vector4(320.12, -193.99, 54.23, 15.03), -- Entire Vector4 Coordinate
