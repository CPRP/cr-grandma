...
Config.IllegalMedicalTarget = {
    Coords = vector3(4963.16, -5108.32, 2.98), -- Coords for the Target
    Width = 0.5, -- Width for the Target
    Length = 0.5, -- Length for the Target
    Heading = 112.51, -- Heading for the Target
    minZ = 0.56, -- Minimum Z for the Target
    maxZ = 4.36, -- Maximum Z for the Target
...
Config.IllegalMedical = {
    Coords = vector4(4963.16, -5108.32, 2.98, 112.51), -- Entire Vector4 Coordinate
